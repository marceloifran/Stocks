...
<body>
    <div class="container py-4">
        <h1 class="text-center shadow-sm h1 alert alert-primary">Escaneo de Asistencia</h1>
        <div id="reader-container" class="mb-4 position-relative">
            <button id="camera-switch-btn" class="shadow btn btn-primary">
        ...
        <div class="mb-4 shadow-sm card">
            <div class="card-header bg-light">
                <div class="mb-0 form-group">
                    <label for="tipoAsistencia" class="mb-2 fs-5">Tipo de Asistencia</label>
                    <select id="tipoAsistencia" class="form-select form-select-lg">
            ...
            <div class="card-footer">
                <button id="fin" class="btn btn-primary w-100" onclick="finalizarAsistencia()">
    ...
    <script type="text/javascript">
        ...
        function mostrarValidado(nroIdentificacion, nombre) {
            ...
            listItem.classList.add('alert', 'alert-success', 'mb-2', 'validated-item');
            ...
            listItem.innerHTML = `
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <span class="badge bg-primary">${estadoSelect.value}</span>
