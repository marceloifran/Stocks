...
<html>
  ...
  <body >
    <div class="container">
                <h1 class="h1 text-center alert alert-danger">Escaneo de Horas</h1>
            ...
            <div style="padding: 10px" class="col-lg-4">
              <div style="display: none">
                ...
                <div class="form-group text-center" style="padding: 20px">
                    <label for="tipoAsistencia" class="fs-4 alert alert-primary text-center">Tipo de Horas</label>
                    <select id="tipoAsistencia" class="form-control fs-5">
                        <option value="Horas de Altura">Horas de Altura</option>
                        <option value="Horas de Hormigon">Horas de Hormigon</option>
                    </select>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
  ...
  console.log('Datos de las Horas:', asistenciaData);

  // Enviar los datos de asistencia al servidor o realizar otras acciones
  axios.post('/guardar-horas', { asistencia: asistenciaData })
    .then(function (response) {
      console.log('Horas guardadas exitosamente.', response.data);
