...
use App\Filament\Resources\WhatsAppTemplateResource\Pages\ManageWhatsAppTemplates;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Textarea::make('content')
                    ...
                    ->required()
                    ->helperText('Puedes usar variables como {product_name} y {quantity} para personalización automática.')
                    ->maxLength(65535)
                    ->columnSpanFull(),
            ]);
    }
